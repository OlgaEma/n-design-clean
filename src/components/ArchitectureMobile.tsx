...
export default function ArchitectureMobile({ language }: Props) {
          ...
          <div className="flex flex-col items-center gap-2 group cursor-pointer">
            {project.thumbnail ? (
              <Image
                ...
                height={600}
                className="w-full rounded shadow-md transition-transform duration-300 group-hover:scale-105 object-cover"
              />
            ) : (
